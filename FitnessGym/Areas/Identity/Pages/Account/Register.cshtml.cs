...
namespace FitnessGym.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        {
            ReturnUrl = returnUrl;
            Subscriptions = new SelectList(_dbContext.Subscriptions.ToList(), "Id", "Type", "Select Subscription Type");
            Programs = new SelectList(_dbContext.Programs.ToList(), "Id", "ProgramName", "Select Program");
